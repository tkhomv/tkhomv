...
|----------------|-----------------|-----|
|Проект 1 Формализации проблемы продукта маркетплейса (__[github](https://github.com/tkhomv/pa_project)__)|Выбор, расчет продуктовых метрик. Проверка гипотез.|pandas,numpy,seaborn, matplotlib|
